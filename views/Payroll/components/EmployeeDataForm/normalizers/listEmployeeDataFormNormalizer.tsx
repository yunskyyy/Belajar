...
import type { EmployeeDataList, ListEmployeeData } from '../EmployeeDataForm.types';

const listEmployeeNormalizer = (data:EmployeeDataList) : EmployeeDataList => {
  const {
...
export default listEmployeeNormalizer;
